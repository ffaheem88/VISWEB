      ...
      <li class="button-dropdown"><a class="dropdown-toggle" id="management"> Management Quality&nbsp; <i class="fa fa-caret-down"></i></a>
         ...
         <li><a href="ratingSect.aspx?sec=19">Sub Sovereign</a></li>
               ...
               <%
                   ...
                   Cmd.Connection = Con
                   'Cmd.CommandText = " select * from [jcrvis_Vista].[dbo].[Vu_CurRating_Home] where  (RatingType IN ('TFC-1', 'TFC-2', 'TFC-3', 'Sukuk 1', 'TFC-4', 'Sukuk 2', 'Sukuk 3', 'Sukuk 4', 'TFC-5')) AND (ActionType <> 'Withdrawn') ORDER BY RHDate DESC"(280)
                   Cmd.CommandText = " select * from [jcrvis_Vista].[jcrvis_sa8].[sectVu_CurRating] where  (RatingType= 'BMR') and actiontype not in ('withdrawn','Discontinued','Matured','Withdrawn from Public') ORDER BY sectortype_code,secname,companyname asc, rhdate desc"
       ...
       <%-- ***********instruments**********--%>
        ...
        arroutlook = Split(Convert.ToString(Rdrins("Outlook")), "|")
						...
						Next
                           ...
                           <% ElseIf(type="BMR") %>
                           <div class="ratings-table" id="BMR" style="display:none;">
                           <div class="ratings-data">
                                ...
                                <%  
                                    ...
                                    Dim sectitlebmr As String
                                 	    
                                   For Each Rdrbmr As System.Data.DataRow In dsbmr.Tables(0).Rows
                                 	       
                                        If (sectitlebmr <> Rdrbmr("Sectortype")) Then%>

                                              <thead class="sector-type"  id="<%=Rdrbmr("Sectortype")%>">
                                 <tr>
                                            <td colspan="7"><h3><%=Rdrbmr("Sectortype")%></h3></td>
                                        </tr>
                                        </thead><%

                                                        End If
                                 	           
                                        sectitlebmr = Rdrbmr("Sectortype")
                                 	        
                                 	       
                                 	        If Rdrbmr("SectorCode") <> Sectorbmr Then%>
                                    <thead class="sector-header"id="<%=Rdrbmr("SecName")%>">


                                        <tr>
                                        <td colspan="7"><h2><%=Rdrbmr("SecName")%></h2></td>
                                        </tr>
                                    </thead>
                                    <thead>
                                        <tr class="fields">
                                        ...
                                        <tr class="files">
                                            <td colspan="7">
                                             ...
                                             <%
                                                 ...
                                                 Response.Write("<li>&nbsp; | &nbsp;<a href='history.aspx?viscode=" & Rdrbmr("viscode") & "'>History</a></li>")
												                     
                                                  
                                                 Dim i As Integer = 0
                                                 
                                                 If (halfyear = Rdrbmr("Fullyear")) Then
                                                        
                                                     Response.Write("<li>&nbsp; | &nbsp;<a target='_Blank' href='RatingReports/OP_" & Rdrbmr("m_RatingCode") & "_000" & Rdrbmr("VisCode") & ".pdf'> Rating Report</a></li> ")
